...
emissions_year <- aggregate(Emissions ~ year, NEI, sum, na.rm = T)
png('pics/plot1.png')# , width = 480, height = 480, units = 'px'
# Plot the chart
plot(emissions_year, type = 'o', main = 'Total PM2.5 emission in United States', xlab = 'Year of emissions recorded', ylab = 'Amount of PM2.5 emitted, in tons')
dev.off()
